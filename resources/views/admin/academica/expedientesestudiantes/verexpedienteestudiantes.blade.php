...
<div class="box">
            <div class="box-header">
              <div class="col-sm-4">
                <h2 class="box-title">Expediente estudiantil</h2>
              </div> 
              </div>            
              ...
              <table class="table table-hover">
                ...
                <tr>            
                 ...
                 <td>P025698</td>
                  ...
                  <td>Mañana</td>
                  <td>                    
                    <a href="{{ route('verexpediente') }}" class="btn btn-primary" ><i class="fa fa-eye"></i></a>
...
<div class="col-sm-8">
        ...
        <div class="form-group">                                           
          ...
          <div class="form-group">                                           
            ...
            <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title"><Strong>Cuenta de Usuario</Strong></h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal">
