...
<div class="box box-primary">
    <div class="box-header with-border">
        <h3 class="box-title"><Strong>Crear expediente estudiantil - Cuenta de Usuario</Strong></h3>
    </div>
    <!-- /.box-header -->
    <!-- form start -->
    ...
    <div class="box-footer" align="right">
        <a href="{{route('registrardatosmedicosestudiante')}}" class="btn btn-primary" onclick="return confirm('Está seguro de la información proporcionada')">Siguiente ></a>
