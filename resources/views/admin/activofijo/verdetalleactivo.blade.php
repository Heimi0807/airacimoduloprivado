...
<div class="box box-primary">
            ...
            <div class="form-group">                                           
                        ...
                        {!! Form::label('lbcuenta', 'Clasificación de activo',['class'=>'col-sm-2 control-label']) !!}
                         <div class="col-sm-4">
                         {!! Form::text('txttipoactivo',null,['class'=>'form-control pull-right','placeholder'=>'Clasificación de activo','required']) !!}
                          </div>
             ...
             <div class="col-sm-12">
                 <div class="form-group"> 
                        ...
                        {!! Form::label('lbcondicion', 'Condición actual',['class'=>'col-sm-2 control-label']) !!}
                         <div class="col-sm-4">
                         {!! Form::text('txtcondicion',null,['class'=>'form-control pull-right','placeholder'=>'Condición actual del activo','required']) !!}
                          </div>
